...
namespace cs2.GameOverlay.UI.Forms
{
    internal class FormAimAssist : UIForm
    {
        ...
        private void InitializeComponents()
        {
            ...
            Add(aim = new UISwitcher("Aim assist (Not Working Rn)", new((x) => SelectedWeapon.EnableAimAssist = x)));
            Add(tb = new UISwitcher("Triggerbot (Not Working Rn)", new((x) => SelectedWeapon.EnableTriggerbot = x)));
